...
import SubscriptionForm from '../Card/Subscription'
const Testimonial = () => {


    return (    

        <div className='bg-primary-testimonial-bluecolor'>
            <section className='grid grid-cols-1 sm:grid-cols-3 grid-rows-1 mt-10 relative z-[1]'>
